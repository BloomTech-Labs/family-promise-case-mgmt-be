exports.up = function (knex) {
  return knex.schema
    ...
    .alterTable('households', (tbl) => {
      ...
      tbl.integer('total_time_homeless_three_years_monthes');
      tbl.integer('total_time_homeless_past_year_year');
      tbl.integer('total_time_homeless_past_year_monthes');
      ...
      tbl.integer('previous_stay_length_monthes');
      ...
      tbl.boolean('needs_interpreter');
      //I have to put disability section here!!
